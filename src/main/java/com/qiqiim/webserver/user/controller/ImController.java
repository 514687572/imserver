...
public class ImController extends BaseController {
    ...
    @ResponseBody
    public Object getAllUser(HttpServletResponse response, HttpServletRequest request, RedirectAttributes redirectAttributes) throws Exception {
    ...
    public String userMessage(HttpServletResponse response, HttpServletRequest request,
        ...
        msg.setContent("牢记域名151860.com/1253222.com认准彩中彩");
