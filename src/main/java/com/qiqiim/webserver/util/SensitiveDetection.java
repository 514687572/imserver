...
public class SensitiveDetection {
	...
	public static final String SENSITIVE_PATH = "com/qiqiim/webserver/util/sensitive.txt";// 热敏词汇地址
	 ...
	 * @throws IOException 
	 */
	public static synchronized void init(List<String> words) throws IOException {
